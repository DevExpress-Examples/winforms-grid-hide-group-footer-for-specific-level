...
Namespace HideableGroupRowFooters
	...
	Public Class MyGridViewInfo
		...
		Protected Overrides Sub CalcRowFooterInfo(ByVal ri As GridRowInfo, ByVal row As GridRow, ByVal nextRow As GridRow)
            ...
            Dim left As Integer = ri.IndentRect.Right - CInt((IIf((Not isShowCurrentFooter), LevelIndent, 0)))
		...
		Public Overrides Overloads Function GetRowFooterCount(ByVal rowHandle As Integer, ByVal rowVisibleIndex As Integer, ByVal isExpanded As Boolean) As Integer
